...
function reload(arr) {
    ...
    for (let title of titles) {
        let movie = arr.find(movie => movie.Title === title); 
        ...
        li.innerHTML = `${index}. ${movie.Title}`;
...
function openModal(movie) {
    ...
    let modalPlot = document.querySelector("#modalPlot");
...
reload(movies);
let closeButton = document.querySelector(".modal-content .close");
let modal = document.querySelector("#myModal");
